...
import 'package:rdi_tele_example/integrated_network_dashboard.dart';
import 'package:rdi_tele_example/screens/privacy_policy_screen.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPermissionStep(
                '4. Enable all permissions', Icons.check_circle),
            const SizedBox(height: 40),
            Column(
              children: [
                SizedBox(
